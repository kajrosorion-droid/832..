                ...
                if p.concept_graph.nodes:
                    ...
                    for i, (sig, data) in enumerate(top_sp):
                        if sig not in other.concept_graph.nodes:
                            if phi_hash(p.id, other.id, hash(sig) % 100000 + i) < Config.CONCEPT_EXCHANGE_PROB:
                        ...
                        elif phi_hash(other.id, p.id, hash(sig) % 100000 + i + 500) < Config.CONCEPT_EXCHANGE_PROB:
